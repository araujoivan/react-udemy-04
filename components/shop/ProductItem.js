...
const ProductItem = props => {
    ...
    // declare this in capital letters to be used as an jsx component
    let TouchableCmp = TouchableOpacity;

    // treatment for having that android ripple effect when a element is touched
    // remembert that this effect works only in android
    if(Platform.OS === 'android' && Platform.Version >= 21) {
        TouchableCmp = TouchableNativeFeedback;
    }
    // touchable accepts just one element as child
    return (
